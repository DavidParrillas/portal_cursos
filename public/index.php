...
$ultimosCursos = $cursoModel->obtenerUltimos(3); // Mostramos solo los últimos 3 cursos
...
<main>
    ...
    <section class="courses-section">
        <h2 class="courses-title">¡Todas las habilidades que necesitas en un único lugar!</h2>
                    ...
                    <article class="course-card">
                        ...
                        <div class="course-content">
                            ...
                            <p class="course-instructor">
                                ...
                                <?= htmlspecialchars($curso['instructor'] ?? 'Instructor no asignado') ?>
                            </p>
                            
                            <footer class="course-stats">
                                <div class="rating">
                                    <span class="star" aria-hidden="true">⭐</span>
                                    <span class="rating-value"><?= number_format($curso['promedio_calificacion'] ?? 0, 1) ?></span>
                                ...
                                <?php if (!empty($curso['total_inscritos'])): ?>
                            ...
                            <div class="course-footer">
                                <div class="course-price">
                                    <?php if (($curso['precio'] ?? 0) > 0): ?>
                                        <span class="price">$<?= number_format($curso['precio'] ?? 0, 2) ?></span>
                                    <?php else: ?>
